...
for data_ind = 1:size(Y, 1)
    ...
    para = load(strcat('./tensorFM_resk9_100iter_sparse1000train/orifm/', 'FM_', data_name, '_train', '.mat')).paraSubsets;
        ...
        for ind2 = 1:numel(paralist2)
            ...
            for ind3 = 1:numel(klist)
                ...
                for ind4 = 1:numel(dup)
                    ...
                    % fprintf("%f,%f,%f.\n", beda_w - para1(ind), beda_P - para2(ind), k - para3(ind))
                    ...
                    parfor i = 1:nval
                        predicted{i} = eva_tfm_ori(Xval_cell{i}, w1, w2, U1, U2, k);
                    end

                    % if beda_w == 1e-6 && beda_P == 1e-4
                    %     U1
                    %     pause(999)
                    % end
        ...
        for ind2 = 1:numel(paralist2)
            ...
            for ind3 = 1:numel(klist)
                ...
                for ind4 = 1:numel(dup)
                    ...
                    parfor i = 1:ntest
                        predicted{i} = eva_tfm_ori(Xtest_cell{i}, w1, w2, U1, U2, k);
                    end
...
totalCell
save(strcat('./tensorFM_finalres/', dataset_name, '_orifm.mat'), 'totalCell')