function [] = tensorFM_handler_subtasks_lifted(dataset_name, genre1, genre2)
    ...
    parfor ind = 1:numel(para1)
        ...
        [w1, w2, U1, U2, V1, V2] = tensorFM_lifted_syn2(X_cell, y_cell, n1, n2, k, beda_w, beda_P, false);
        tempCell = cell(1, 6);
        tempCell{1} = w1;
        tempCell{2} = w2;
        tempCell{3} = U1;
    ...
    save(strcat('./tensorFM_resk9_100iter_sparse1000train/lifted/', dataset, '.mat'), 'paraSubsets');
